...
async function runAllFormTests() {
  ...
  log(`📋 Testing ${Object.keys(CONFIG.scenarios).length} scenarios on ${CONFIG.formEndpoints.length} endpoints\n`, 'cyan');
...
function displayFormSummary(results) {
  ...
  scenarios.forEach(scenario => {
    ...
    log(`   ${scenario}: ${scenarioSuccess}/${scenarioTotal} (${Math.round((scenarioSuccess/scenarioTotal)*100)}%)`, 
