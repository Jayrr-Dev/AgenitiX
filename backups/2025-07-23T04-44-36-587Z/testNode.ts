 ...
 * Theming & Design:
 * - Category: TEST
 * - Design Tokens: var(--node-test-bg), var(--node-test-border), var(--node-node-text)
...
export const testNodeDataSchema = z.object({
  ...
  /** Required string field (default: "\"FE0\"") */
  expandedSize: z.string().default("\"FE0\""),
  /** Required string field (default: "\"C1\"") */
  collapsedSize: z.string().default("\"C1\""),
  /** Optional string field */
  receivedData: z.string().default(""),
});
...
export const testNodeSpec = {
  ...
  controls: {
    autoGenerate: true,
    excludeFields: ["isActive","expandedSize","collapsedSize"],
    customFields: []
  },
  icon: 'FileText',
  author: 'Agenitix Team',
