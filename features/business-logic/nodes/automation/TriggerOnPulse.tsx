...
const TriggerOnPulse: React.FC<
  NodeProps<Node<TriggerOnPulseData & Record<string, unknown>>>
> = ({ id, data }) => {
  ...
  return (
    <div
      className={`relative ${showUI ? "px-4 py-3 min-w-[180px] min-h-[120px]" : "w-[60px] h-[60px] flex items-center justify-center"} rounded-lg bg-amber-100 dark:bg-amber-900 shadow border border-amber-300 dark:border-amber-800`}
    >
