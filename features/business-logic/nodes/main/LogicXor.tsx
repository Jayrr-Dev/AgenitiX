...
// -----------------------------------------------------------------------------
const LogicXor: React.FC<
  NodeProps<Node<LogicXorData & Record<string, unknown>>>
> = ({ id, data }) => {
  ...
  return (
    <div
      className={`relative ${showUI ? "px-4 py-3 min-w-[120px] min-h-[120px]" : "w-[60px] h-[60px] flex items-center justify-center"} rounded-lg bg-purple-100 dark:bg-purple-900 shadow border border-purple-300 dark:border-purple-800`}
    >
      ...
      {!showUI && (
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-16 h-16 flex items-center justify-center">
            <div
              className={`text-lg font-bold ${xorResult ? "text-purple-700 dark:text-purple-300" : "text-purple-400 dark:text-purple-600"}`}
            >
              XOR
            </div>
          </div>
