...
// TYPES
// -----------------------------------------------------------------------------
interface IconForPulseCyclesProps {
...
// -----------------------------------------------------------------------------
const IconForPulseCycles: React.FC<IconForPulseCyclesProps> = ({ progress, onToggle, isRunning, label, size = 100, color = '#10b981' }) => {
  // Clamp progress between 0 and 1
  const pct = Math.max(0, Math.min(1, progress))
  // Chart data for radial - map progress to start from top
