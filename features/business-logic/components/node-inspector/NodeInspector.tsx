    ...
    return (
      <div id="node-info-container" className="flex gap-3">
        ...
        <div className="flex-1 flex flex-col gap-3 min-w-0 w-full">
          <NodeHeader node={node} onUpdateNodeId={onUpdateNodeId} onDeleteNode={onDeleteNode} onDuplicateNode={onDuplicateNode} />
  ...
  return (
    <div className="flex items-center justify-center h-5 w-4">
      <button
        ...
        onClick={() => inspectorState.setLocked(true)}
