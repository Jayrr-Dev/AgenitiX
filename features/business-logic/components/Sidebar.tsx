...
const DEFAULT_STENCILS_A: Record<TabKeyA, NodeStencil[]> = {
  main: [
    { id: 'main-text-1', nodeType: 'textNode', label: 'Text', description: 'Create and edit text content. Use the textarea to type your message, then connect to other nodes to pass the text along.' },
    { id: 'main-upper-1', nodeType: 'uppercaseNode', label: 'Uppercase', description: 'Takes any text input and converts it to ALL CAPITAL LETTERS. Perfect for making text stand out or formatting headers.' },
    { id: 'main-output-1', nodeType: 'output', label: 'Output', description: 'Display the final result of your flow. Connect any node to see its output value in a clean, readable format.' },
    { id: 'main-trigger-1', nodeType: 'triggerOnClick', label: 'Trigger', description: 'Acts like a gate - click the button to allow data to flow through. Great for controlling when things happen in your flow.' },
    { id: 'main-pulse-1', nodeType: 'triggerOnPulse', label: 'Pulse Trigger', description: 'Sends a quick "pulse" signal when clicked. Like pressing a doorbell - one click sends one signal to connected nodes.' },
    { id: 'main-cycle-1', nodeType: 'triggerOnPulseCycle', label: 'Pulse Cycle', description: 'Automatically sends repeated pulses at timed intervals. Set how often and how many times to create automated sequences.' },
    { id: 'main-toggle-1', nodeType: 'triggerOnToggle', label: 'Toggle Trigger', description: 'A simple ON/OFF switch. Click to toggle between true and false states. Perfect for enabling/disabling parts of your flow.' },
    { id: 'main-toggle-cycle-1', nodeType: 'triggerOnToggleCycle', label: 'Toggle Cycle', description: 'Automatically switches between ON and OFF states. Set custom durations for each state to create blinking or cycling patterns.' },
    { id: 'main-and-1', nodeType: 'logicAnd', label: 'AND (⋀)', description: 'Only outputs TRUE when ALL connected inputs are true. Like saying "I need this AND that AND the other thing to proceed."' },
    { id: 'main-or-1', nodeType: 'logicOr', label: 'OR (⋁)', description: 'Outputs TRUE when ANY connected input is true. Like saying "I need this OR that OR any of these options to proceed."' },
    { id: 'main-not-1', nodeType: 'logicNot', label: 'NOT (¬)', description: 'Flips the input - turns TRUE into FALSE and FALSE into TRUE. Perfect for creating opposite conditions.' },
    { id: 'main-xor-1', nodeType: 'logicXor', label: 'XOR (⊕)', description: 'Only TRUE when exactly one input is true. Like an "either/or" choice - you can have one thing OR another, but not both.' },
    { id: 'main-xnor-1', nodeType: 'logicXnor', label: 'XNOR (⊙)', description: 'TRUE when all inputs match (all true OR all false). Perfect for checking if things are "in sync" with each other.' },
    { id: 'main-text-converter-1', nodeType: 'textConverterNode', label: 'Text Converter', description: 'Converts any input (numbers, objects, etc.) into readable text. Great for displaying complex data as simple text.' },
    { id: 'main-boolean-converter-1', nodeType: 'booleanConverterNode', label: 'Boolean Converter', description: 'Converts any input into TRUE or FALSE. Numbers become false if zero, text becomes false if empty, etc.' },
    { id: 'main-input-tester-1', nodeType: 'inputTesterNode', label: 'Input Tester', description: 'Create test values to experiment with your flow. Type in any value and see how it affects connected nodes.' },
    { id: 'main-object-editor-1', nodeType: 'objectEditorNode', label: 'Object Editor', description: 'Create and edit complex data objects with multiple properties. Perfect for structured data like user profiles or settings.' },
    { id: 'main-array-editor-1', nodeType: 'arrayEditorNode', label: 'Array Editor', description: 'Create and edit lists of items. Great for managing collections like shopping lists, user groups, or data sets.' },
    { id: 'main-counter-1', nodeType: 'counterNode', label: 'Counter', description: 'Counts up or down automatically. Set the starting number and step size. Counts each time it receives an input signal.' },
    { id: 'main-delay-1', nodeType: 'delayNode', label: 'Delay', description: 'Adds a time delay to your flow. Data goes in, waits for the specified time, then comes out. Perfect for creating timed sequences.' },
  ],
