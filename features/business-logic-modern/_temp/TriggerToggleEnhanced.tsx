...
//     updateNodeData: (
//       id: string,
//       updates: Partial<TriggerToggleEnhancedData>
//     ) => void
//   ) => {
...
//       console.error(
//         `TriggerToggleEnhanced ${id} - Processing error:`,
//         processingError
//       );
//       const errorMessage =
...
//                 onChange={(e) =>
//                   updateNodeData(id, { autoToggle: e.target.checked })
//                 }
//                 disabled={!!finalError}
//                 className="shrink-0"
//               />
//               <label className={`text-xs ${categoryTextTheme.secondary}`}>
//                 Auto-toggle on trigger
//               </label>
//             </div>
...
//                 onChange={(e) =>
//                   updateNodeData(id, { pulseMode: e.target.checked })
//                 }
//                 disabled={!!finalError}
//                 className="shrink-0"
//               />
...
//               <div className="flex items-center gap-1">
//                 <label
//                   className={`text-xs w-10 shrink-0 ${categoryTextTheme.secondary}`}
//                 >
//                   Hold:
//                 </label>
//                 <input
...
//                     updateNodeData(id, {
//                       holdDuration: Math.max(100, numValue),
//                     });
//                   }}
...
//                 />
//                 <span
//                   className={`text-xs w-6 shrink-0 ${categoryTextTheme.secondary}`}
//                 >
//                   ms
//                 </span>
//               </div>
...
// export const cleanupTriggerToggleEnhancedTimers = (
//   id: string,
//   data: TriggerToggleEnhancedData
// ) => {
//   PulseTimerManager.clearPulse(id, data);
