...
// /*  – Run: npx ts-node features/business-logic-new/tooling/dev-scripts/generate-from-registry.ts */
// /* -------------------------------------------------------------------------- */
...
// } from "@/features/business-logic-modern/infrastructure/node-registries/modern/EnhancedNodeRegistry";
...
// Object.entries(nodeTypeConfig).forEach(
//   ([nodeType, config]: [string, NodeTypeConfig]) => {
//     console.log(`  ${nodeType}: {`);
//     console.log(
//       `    defaultData: ${JSON.stringify(config.defaultData, null, 6).replace(/\n/g, "\n    ")},`
//     );
...
// const inspectorMapping: Record<string, InspectorControlConfig> =
//   generateInspectorControlMapping();
// console.log("// Auto-generated inspector control mapping:");
// console.log("const NODE_INSPECTOR_CONTROLS = {");
// Object.entries(inspectorMapping).forEach(
//   ([nodeType, controlConfig]: [string, InspectorControlConfig]) => {
//     console.log(`  ${nodeType}: {`);
//     console.log(`    type: '${controlConfig.type}',`);
//     if (controlConfig.legacyControlType) {
//       console.log(
//         `    legacyControlType: '${controlConfig.legacyControlType}'`
//       );
//     }
//     if (controlConfig.controlGroups) {
//       console.log(
//         `    controlGroups: ${JSON.stringify(controlConfig.controlGroups, null, 4)}`
//       );
//     }
//     console.log(`  },`);
//   }
...
// const factoryNodes = Object.values(ENHANCED_NODE_REGISTRY).filter(
//   (n) => n.inspectorControls?.type === "factory"
// ).length;
// const legacyNodes = Object.values(ENHANCED_NODE_REGISTRY).filter(
//   (n) => n.inspectorControls?.type === "legacy"
// ).length;
// const noControlNodes = Object.values(ENHANCED_NODE_REGISTRY).filter(
//   (n) => n.inspectorControls?.type === "none"
// ).length;

// console.log(`📊 Registry Statistics:`);
// console.log(`   • Total nodes: ${totalNodes}`);
// console.log(
//   `   • Factory nodes: ${factoryNodes} (modern, auto-generated controls)`
// );
// console.log(
//   `   • Legacy nodes: ${legacyNodes} (manual controls, will be migrated)`
// );
// console.log(`   • No control nodes: ${noControlNodes} (view/logic nodes)`);

// console.log(`\n🚀 Registration Process Comparison:`);
// console.log(
//   `   BEFORE: 4+ files to edit manually, 10+ minutes, high error rate`
// );
// console.log(
//   `   AFTER:  1 registry entry, auto-generated everything, 30 seconds`
// );
...
// console.log(
//   `   ✅ sidebar/constants.ts - Auto-generated from getAvailableNodes()`
// );
// console.log(
//   `   ✅ nodeStyleStore.ts - Auto-generated from getCategoryMapping()`
// );

// console.log(`\n💡 Next Steps for Ultimate Zero-Touch Registration:`);
// console.log(
//   `   1. Migrate remaining ${legacyNodes} legacy nodes to factory system`
// );
