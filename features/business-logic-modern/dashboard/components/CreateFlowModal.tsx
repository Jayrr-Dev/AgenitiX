    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Set up your new automation workflow with a name, description, and
            privacy settings.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Choose an icon to automatically categorize your flow. The icon you
              select will help others discover and understand your workflow.
            </p>

            <Tabs
              value={activeIconTab}
              onValueChange={setActiveIconTab}
              className="w-full"
            >
                ...
                <TabsContent key={key} value={key} className="mt-4">
                  <div className="mb-3 p-3 bg-muted/30 rounded-lg border border-border">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Flows with {category.label.toLowerCase()} icons will
                      appear in the {category.label.toLowerCase()} category when
                      shared publicly.
                    </p>
                  </div>
