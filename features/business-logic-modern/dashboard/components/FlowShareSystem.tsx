                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-700 dark:text-amber-300">
                      Users with the link will need your permission to access
                      this flow.
                    </p>
                  </div>
                </div>
                  ...
                  <div key={request._id} className="p-3 border rounded-lg">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        ...
                        variant="outline"
                        onClick={() =>
                          handleRespondToRequest(request._id, "denied")
                        }
                      >
                        Deny
                      </Button>
                    ...
                    {[
                      ...
                      return (
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            setRequestPermission(permission.value as any)
                          }
