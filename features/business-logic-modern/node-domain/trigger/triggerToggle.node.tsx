...
const validateNodeData = createNodeValidator(TriggerToggleDataSchema, "TriggerToggle");
...
const TriggerToggleNode = memo(({ id, data, spec }: NodeProps & { spec: NodeSpec }) => {
	...
	useNodeDataValidation(TriggerToggleDataSchema, "TriggerToggle", validation.data, id);
