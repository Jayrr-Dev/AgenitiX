...
export const EmailAccountCollapsed = memo(
  ({ nodeData, categoryStyles }: EmailAccountCollapsedProps) => {
    ...
    const providerInfo = useMemo(() => {
      const providers = {
        ...
        yahoo: { name: "Yahoo", icon: FaYahoo, color: "text-purple-600" },
    ...
    const statusDotColor = useMemo(() => {
      return (
        COLLAPSED_STYLES.statusColors[
          connectionStatus as keyof typeof COLLAPSED_STYLES.statusColors
        ] || COLLAPSED_STYLES.statusColors.disconnected
      );
    }, [connectionStatus]);
      ...
      <div className={COLLAPSED_STYLES.container}>
        <div className={COLLAPSED_STYLES.content}>
          ...
          <div className="flex justify-center">
            <div className={COLLAPSED_STYLES.providerIcon}>
              <IconComponent
          ...
          <div className={COLLAPSED_STYLES.emailInfo}>
            ...
            <div className={COLLAPSED_STYLES.statusIndicator}>
              <span
                className={`${COLLAPSED_STYLES.statusDot} ${statusDotColor}`}
              ></span>
            </div>
          </div>
        </div>
