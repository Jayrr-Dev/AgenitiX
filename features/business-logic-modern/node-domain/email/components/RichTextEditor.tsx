...
export function RichTextEditor({ value, onChange, disabled = false, placeholder = "Enter your message..." }: RichTextEditorProps) {
    ...
    const handleModeChange = useCallback((newMode: "text" | "html" | "rich") => {
        let newContent = { ...value, mode: newMode };
        ...
        <div className="flex gap-1 mb-2">
            {(["rich", "html", "text"] as const).map((mode) => (
                <button
                    ...
                    className={`px-2 py-1 text-xs rounded border ${value.mode === mode
    ...
    const renderToolbar = () => {
        if (value.mode !== "rich" || disabled) return null;
        ...
        if (value.mode === "rich") {
            return (
                <div
                    ...
                    className={`w-full min-h-[120px] p-3 border rounded text-sm ${disabled
    ...
    return (
        <div className="rich-text-editor">
            ...
            <div className="mt-2 text-xs text-gray-500 flex justify-between">
                ...
                {value.mode === "rich" && (
                    <span>Use Ctrl+B, Ctrl+I, Ctrl+U for formatting</span>
                )}
            </div>
