...
export const EmailBrandDataSchema = z
  .object({
    ...
    brandType: z
      .enum(["corporate", "personal", "product", "campaign"])
      .default("corporate"),
...
const EmailBrandNode = memo(({ id, spec }: NodeProps & { spec: NodeSpec }) => {
  ...
  const [activeTab, setActiveTab] = useState<
    "identity" | "colors" | "typography" | "signature"
  >("identity");
...
<div class="email-signature">
  ...
  /** Update output when brand changes */
  useEffect(() => {
            ...
            <div className="space-y-2">
              <div>
                ...
                <input
                  ...
                  value={logo.url}
                  onChange={(e) =>
                    updateNodeData({ logo: { ...logo, url: e.target.value } })
                  }
                  placeholder="https://example.com/logo.png"
                  className="w-full px-2 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                  disabled={!isEnabled}
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateNodeData({
                        logo: { ...logo, width: Number(e.target.value) },
                      })
                    }
                    className="w-full px-2 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                    disabled={!isEnabled}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateNodeData({
                        logo: { ...logo, height: Number(e.target.value) },
                      })
                    }
                    className="w-full px-2 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                    disabled={!isEnabled}
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 mb-2">
                <input
                  ...
                  onChange={(e) =>
                    updateNodeData({
                      signature: { ...signature, enabled: e.target.checked },
                    })
                  }
                  className="rounded"
                  disabled={!isEnabled}
                ...
                <div className="space-y-2">
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateNodeData({
                            signature: { ...signature, title: e.target.value },
                          })
                        }
                        placeholder="CEO"
                        className="w-full px-2 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateNodeData({
                          signature: { ...signature, company: e.target.value },
                        })
                      }
                      placeholder="Acme Corp"
                      className="w-full px-2 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
...
const EmailBrandNodeWithDynamicSpec = (props: NodeProps) => {
  ...
  const dynamicSpec = useMemo(
    ...
    [
      (nodeData as EmailBrandData).expandedSize,
      (nodeData as EmailBrandData).collapsedSize,
    ]
  );
  ...
  const ScaffoldedNode = useMemo(
    () =>
      withNodeScaffold(dynamicSpec, (p) => (
        <EmailBrandNode {...p} spec={dynamicSpec} />
      )),
    [dynamicSpec]
  );
