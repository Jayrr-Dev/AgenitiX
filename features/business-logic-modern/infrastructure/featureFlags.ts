...
// Public flag constant for automations orchestration
export const FLAG_AUTOMATIONS = "automations" as const; // [Explanation], basically master gate for workflow runner
