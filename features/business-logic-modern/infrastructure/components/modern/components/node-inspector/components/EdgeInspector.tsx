      ...
      <div className="bg-blue-50 dark:bg-blue-900/30 rounded-md border border-blue-200 dark:border-blue-800 p-2">
        <div className="text-xs">
          ...
          <div className="space-y-1 text-blue-800 dark:text-blue-200">
            ...
            <div>✓ Data flow: {sourceType.label} → {targetType.label}</div>
            <div>✓ Handle types: {sourceHandle === 'default' ? 'Auto-detected' : 'Typed'} → {targetHandle === 'default' ? 'Auto-detected' : 'Typed'}</div>
