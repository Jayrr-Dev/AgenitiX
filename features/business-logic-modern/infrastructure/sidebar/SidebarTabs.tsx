...
export function SidebarTabs({
  ...
  return (
    <Tabs value={activeTab} onValueChange={onTabChange}>
      <aside className="absolute bottom-4 right-4 z-30 h-[200px] sm:h-[280px] w-full sm:w-[400px] lg:w-[450px] pl-3 sm:pl-6 pr-3 sm:pr-5 pt-2 rounded-lg bg-[hsl(var(--infra-sidebar-bg))] border border-[hsl(var(--infra-sidebar-border))] shadow-lg transition-all duration-300 ease-in-out">
        <StencilInfoPanel stencil={uiState.hovered} />

        <TabsList className="bg-[hsl(var(--infra-sidebar-bg))] items-stretch justify-between w-full gap-1 border-0 border-[hsl(var(--infra-sidebar-border))]">
          {tabs.map(({ key, label }, index) => {
            ...
            return (
              <TabsTrigger
                ...
                className="text-[hsl(var(--infra-sidebar-text))] hover:bg-[hsl(var(--infra-sidebar-bg-hover))] hover:border-[hsl(var(--infra-sidebar-border-hover))] data-[state=active]:bg-[hsl(var(--infra-sidebar-bg-active))] data-[state=active]:text-[hsl(var(--infra-sidebar-text))] transition-colors rounded px-3 py-2 border border-transparent"
              >
                {label}
              </TabsTrigger>
            );
          ...
          <button
            ...
            className="p-2 mr-1 rounded hover:bg-[hsl(var(--infra-sidebar-bg-hover))] hover:border-[hsl(var(--infra-sidebar-border-hover))] text-[hsl(var(--infra-sidebar-text))] flex items-center gap-1 border border-transparent transition-colors"
            title="Search all nodes (6)"
          >
            <Search className="h-4 w-4 text-[hsl(var(--infra-sidebar-text))]" />
            {/* <span className="hidden sm:inline">Search</span> */}
            {/* <span className="hidden lg:inline text-xs text-infra-sidebar-secondary">⌘K</span> */}
          </button>
        </TabsList>

        <div className="max-h-[150px] sm:max-h-[230px] overflow-y-auto scrollbar pb-2 border-0 bg-[hsl(var(--infra-sidebar-bg))]">
          {tabs.map(({ key }) => {
