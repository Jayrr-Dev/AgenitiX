...
export function SearchBar({
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      const shouldThrottle = notTyping && notAltQ && lastKeyPress;
      ...
      const shouldUpdateTimestamp = notAltQ && notTyping;
                ...
                >
                  <div className="space-y-2">
                    ...
                    <div className="text-[var(--infra-sidebar-text-secondary)]">
                      Press Q, W, E, R, T, A, S, D, F, G, Z, X, C, V, B to
                      create nodes • Press 6 to return to input
                    </div>
                  </div>
                </motion.div>
              )}
