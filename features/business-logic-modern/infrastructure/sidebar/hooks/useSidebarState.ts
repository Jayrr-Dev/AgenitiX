...
export function useSidebarState() {
	...
	const [customNodes, setCustomNodes] = useState<NodeStencil[]>(DEFAULT_CUSTOM_NODES);
	...
	useEffect(() => {
		...
		const storedCustomNodes = loadFromStorage(STORAGE_KEYS.CUSTOM_NODES, DEFAULT_CUSTOM_NODES);
