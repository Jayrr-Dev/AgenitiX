				...
				>
					<div className="space-y-2">
						<div className="flex items-center justify-between">
							<div className="font-medium text-[var(--infra-sidebar-text)]">{stencil.label}</div>
							{categoryInfo && (
						...
						<div className="text-[var(--infra-sidebar-text-secondary)]">{stencil.description}</div>
						{categoryInfo && (
							<div className="text-[var(--infra-sidebar-text-secondary)] text-xs">
								<span className="font-medium">Category:</span> This node belongs to the{" "}
