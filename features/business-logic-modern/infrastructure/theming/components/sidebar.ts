...
export const SIDEBAR_TOKENS = {
	...
	layout: {
		...
		content: combineTokens(CORE_TOKENS.layout.flexCol, "flex-1 overflow-y-auto"),
...
export const sidebarStyles = {
	// Container styling
	getContainer: (isExpanded = true) =>
		getConditionalSidebarVariant("container", isExpanded, "expanded", "collapsed"),

	getSection: (variant: keyof typeof SIDEBAR_TOKENS.variants.section = "default") =>
