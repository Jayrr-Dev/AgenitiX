/**
 * USE REACT FLOW HANDLERS HOOK - ReactFlow event management system
 *
 * • Manages ReactFlow node and edge change handlers with type safety
 * • Handles connection validation and edge reconnection functionality
 * • Provides selection change handlers for nodes and edges
 * • Manages ReactFlow instance initialization and refs
 * • Integrates with connection validation and edge styling systems
 *
 * Keywords: ReactFlow, handlers, connections, validation, selection, instance
 */
