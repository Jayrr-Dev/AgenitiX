...
export class StateComparator {
   ...
   */
  compare(current: Record<string, any>, incoming: Partial<Record<string, any>>): StateComparisonResult {
   ...
   */
  private comparePrimitive(current: Record<string, any>, incoming: Partial<Record<string, any>>): { hasChanges: boolean; changedKeys: string[] } {
   ...
   */
  private compareDeep(current: Record<string, any>, incoming: Partial<Record<string, any>>): { hasChanges: boolean; changedKeys: string[] } {
    const changedKeys: string[] = [];
   ...
   */
  private compareFallback(current: Record<string, any>, incoming: Partial<Record<string, any>>): { hasChanges: boolean; changedKeys: string[] } {
    const changedKeys: string[] = [];
