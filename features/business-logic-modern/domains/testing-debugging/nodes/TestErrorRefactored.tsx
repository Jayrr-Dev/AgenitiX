...
import { createNodeComponent, createTriggeredNodeConfig, type BaseNodeData } from '@factory/RefactoredNodeFactory';
import { getSingleInputValue, isTruthyValue } from '@factory/utils/nodeUtils';
import { useFlowStore } from '@theming/stores/flowStore';
      ...
      return (
        <div className="flex text-xs flex-col w-auto">
          <div className={`font-semibold mb-2 flex items-center justify-between ${categoryTextTheme.primary}`}>
            <span>{error ? 'System Error' : 'Error Generator (Refactored)'}</span>
            {data.isGeneratingError && (
