...
import { getAvailableNodes, getTestingNodes, autoGenerateStencils } from '../../nodes/nodeRegistry';
...
export const DEFAULT_STENCILS_D: Record<TabKeyD, NodeStencil[]> = {
  ...
  triggers: autoGenerateStencils({ folder: 'automation', category: 'trigger' }, 'triggers'),
  flow: [],
  // Cyclers: Automation folder cycle nodes
  cyclers: autoGenerateStencils({ folder: 'automation', category: 'cycle' }, 'cyclers'),
  smart: [],
  tools: [],
};
