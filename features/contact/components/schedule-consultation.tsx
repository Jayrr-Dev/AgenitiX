...
export default function ScheduleConsultation() {
	...
	const SuccessScreen = () => (
		<div className="flex flex-col items-center justify-center py-8 text-center">
			...
			<div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg w-full max-w-md mb-6">
				...
				<div className="space-y-2 text-left">
					<p>
						...
						{formatDateForDisplay(submissionDetails.date)}
					</p>
					<p>
						<span className="font-medium">Time:</span> {submissionDetails.time}
					</p>
					<p>
						<span className="font-medium">Topic:</span> {submissionDetails.topic}
					</p>
				</div>
			</div>
			...
			<Button onClick={() => setIsOpen(false)} className="bg-[#f6733c] hover:bg-[#e45f2d]">
				Close
			</Button>
		</div>
	);
