...
import type { AnubisConfig, AnubisChallenge, AnubisChallengeResponse, AnubisJWTPayload } from './types/anubis';
import { loadAnubisConfig, RouteProtectionManager } from './lib/config';
...
export class Anubis {
  ...
  createChallenge(request: {
    ...
    ip?: string;
  }, difficulty?: number): AnubisChallenge {
