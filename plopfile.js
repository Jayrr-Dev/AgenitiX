  ...
  plop.setGenerator('node', {
    ...
    actions: [
      ...
      },
      {
        ...
        template: '// Add new node imports here (Plop can auto-inject these)\nimport {{kind}} from \'../../../node-domain/{{domain}}/{{kind}}.node\';',
      },
      {
        type: 'modify',
        path: 'features/business-logic-modern/infrastructure/flow-engine/hooks/useDynamicNodeTypes.ts',
      ...
      },
      {
        ...
        template: '// Node exports will be added here automatically by Plop\nexport { default as {{kind}} } from \'./{{domain}}/{{kind}}.node\';',
      },
    ],
  });
    ...
    actions: data => {
      ...
      return [
        ...
        },
        {
          type: 'modify',
          path: 'features/business-logic-modern/infrastructure/flow-engine/hooks/useDynamicNodeTypes.ts',
          pattern: new RegExp(`import ${kind} from '..*?/node-domain/${domain}/${kind}.node';\\r?\\n`, 'g'),
          template: '',
        },
        {
          type: 'modify',
        ...
        },
        {
          type: 'modify',
          path: 'features/business-logic-modern/infrastructure/node-registry/nodespec-registry.ts',
          pattern: new RegExp(`import ${kind}, { spec as ${kind}Spec } from '..*?/node-domain/${domain}/${kind}.node';\\r?\\n`, 'g'),
          template: '',
        },
        {
          type: 'modify',
        ...
        },
        {
          type: 'modify',
          path: 'features/business-logic-modern/node-domain/index.ts',
          pattern: new RegExp(`export { default as ${kind} } from './${domain}/${kind}.node';\\r?\\n`, 'g'),
          template: '',
        },
