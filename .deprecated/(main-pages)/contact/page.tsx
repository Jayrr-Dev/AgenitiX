		...
		<div className="container mx-auto px-4 py-12">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">(780) 555-0123</p>
					...
					<div className="relative h-[300px] rounded-lg overflow-hidden ">
						<iframe
							src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4740.956036094691!2d-113.63212153915934!3d53.54923380401824!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x53a020de2209832f%3A0xebd2b79d62c20f2d!2sEdmonton%2C%20AB%20T5S%202H1!5e0!3m2!1sen!2sca!4v1745604616646!5m2!1sen!2sca"
							width="800"
							height="450"
							style={{ border: 0 }}
				...
				<div className="grid md:grid-cols-2 gap-6">
					<div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
						<h3 className="text-xl font-medium mb-3">
							What services does Utilitek Solutions offer?
						</h3>
						<p className="text-gray-700 dark:text-gray-300">
							We provide comprehensive engineering consulting services for utility and
							infrastructure projects, including electrical utility design, servicing projects, and
							general distribution design.
						</p>
					</div>
					<div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
						<h3 className="text-xl font-medium mb-3">
							Do you work on projects outside of Alberta?
						</h3>
						<p className="text-gray-700 dark:text-gray-300">
							Yes, while our headquarters is in Edmonton, but we are open to expanding our
							opportunities.
						</p>
					</div>
					<div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
						...
						<p className="text-gray-700 dark:text-gray-300">
							You can request a quote by filling out our contact form, calling our office, or
							sending an email with your project details. We aim to respond to all inquiries within
					...
					<div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
						...
						<p className="text-gray-700 dark:text-gray-300">
							To help us understand your needs, please provide project scope, timeline, location,
							and any specific requirements or challenges. The more details you can share, the
			...
			<div className="bg-blue-50 dark:bg-blue-900 p-8 rounded-lg text-center">
				...
				<p className="text-gray-700 dark:text-gray-300 mb-6 max-w-2xl mx-auto">
					Our team of experienced engineers is ready to help you bring your vision to life. Contact
