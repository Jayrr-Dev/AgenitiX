		...
		<div className="container mx-auto px-4 py-12">
			<div className="text-center mb-16">
				...
				<p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
					Delivering innovative electrical distribution solutions across Canada with expertise and
					precision. Handing over <span className="font-bold">200+ projects annually</span> on time
					and on budget.
				</p>
			</div>
