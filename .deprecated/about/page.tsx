		...
		<div className="container mx-auto px-4 py-12">
			<div className="text-center mb-16">
				...
				<p className="text-xl text-gray-600 dark:text-gray-400">
					Powering Innovation in Electrical Distribution
				</p>
			</div>
				...
				<div className="absolute inset-0 bg-linear-to-r from-black/70 to-transparent flex items-center">
					<div className="text-white max-w-xl p-12">
						...
						<p className="text-xl mb-6">
							Since 2014, we've been engineering the future of electrical distribution systems
							across Alberta.
						</p>
			...
			<div className="grid md:grid-cols-2 gap-12 items-center mb-20">
				<div>
					...
					<p className="text-gray-700 dark:text-gray-300 mb-4">
						Founded in 2014 by Sam a former manager in Capital Engineering. Utilitek Solutions Inc.
						emerged from a passion for engineering and a vision to provide the best electrical
						distribution engineering services in Canada. What began as a small team of passionate
						engineers has grown into one of Edmonton's most reliable and reputable consulting firms
						for utility infrastructure.
					</p>
					<p className="text-gray-700 dark:text-gray-300 mb-4">
						Our specialized focus on distribution systems and engineering design has allowed us to
						develop unparalleled expertise in grid modernization, system integration, overhead
						design and underground design that are reshaping Canada's energy landscape.
					</p>
					<p className="text-gray-700 dark:text-gray-300">
						Today, our specialized teams of engineers and technical experts brings decades of
						combined experience, having successfully delivered over 1000 distribution projects in
						the Edmonton area and across Alberta.
					</p>
				</div>
			...
			<div className="mb-20">
				...
				<div className="grid md:grid-cols-3 gap-8">
					<div className="text-center p-8 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow">
						...
						<p className="text-gray-700 dark:text-gray-300">
							We maintain the highest standards of engineering precision and innovation in every
					...
					<div className="text-center p-8 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow">
						...
						<p className="text-gray-700 dark:text-gray-300">
							We pioneer distribution solutions that balance reliability, efficiency, and
					...
					<div className="text-center p-8 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow">
						...
						<p className="text-gray-700 dark:text-gray-300">
							We build lasting relationships through transparent communication and exceeding
				...
				<div className="grid md:grid-cols-2 gap-8">
					<div className="flex gap-6">
						...
						<div>
							...
							<p className="text-gray-700 dark:text-gray-300">
								Design and optimization of electrical distribution networks for urban and rural
								areas.
							</p>
						</div>
					</div>
					<div className="flex gap-6">
						...
						<div>
							...
							<p className="text-gray-700 dark:text-gray-300">
								Design and implementation of smart city solutions, including street lighting,
								traffic control, and public safety systems.
							</p>
						</div>
					</div>
					<div className="flex gap-6">
						...
						<div>
							...
							<p className="text-gray-700 dark:text-gray-300">
								Design and implementation of power systems for a wide range of applications, from
								small residential systems to large industrial complexes.
							</p>
						</div>
					</div>
					<div className="flex gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md">
			...
			<div className="bg-blue-50 dark:bg-blue-900 p-8 rounded-lg text-center">
				<h2 className="text-2xl font-semibold mb-4">
					Ready to transform your distribution infrastructure?
				</h2>
				<p className="text-gray-700 dark:text-gray-300 mb-6 max-w-2xl mx-auto">
					Our team of specialized electrical engineers is ready to help you design, upgrade, or
					optimize your distribution systems.
				</p>
