...
export function validateStateToken(receivedState: string | null, expectedState: string | null): boolean {
...
export function buildErrorResponse(message: string, details?: string, status: number = 400) {
