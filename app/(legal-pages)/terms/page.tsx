		...
		<div className="container mx-auto px-4 py-12">
			...
			<div className="mb-16 rounded-lg bg-white p-8 shadow-md dark:bg-gray-800">
				<div className="prose dark:prose-invert max-w-none">
					...
					<section>
						<h2 className="mb-4 font-semibold text-2xl">2. Services</h2>
						<p className="mb-4 text-gray-700 dark:text-gray-300">
					...
					<section>
						<h2 className="mb-4 font-semibold text-2xl">3. Professional Standards</h2>
						<p className="mb-4 text-gray-700 dark:text-gray-300">
					...
					<section>
						<h2 className="mb-4 font-semibold text-2xl">4. Client Responsibilities</h2>
						<p className="mb-4 text-gray-700 dark:text-gray-300">
					...
					<section>
						<h2 className="mb-4 font-semibold text-2xl">5. Intellectual Property</h2>
						<p className="mb-4 text-gray-700 dark:text-gray-300">
					...
					<section>
						<h2 className="mb-4 font-semibold text-2xl">6. Payment Terms</h2>
						<p className="mb-4 text-gray-700 dark:text-gray-300">
					...
					<section>
						<h2 className="mb-4 font-semibold text-2xl">8. Termination</h2>
						<p className="mb-4 text-gray-700 dark:text-gray-300">
					...
					<section>
						<h2 className="mb-4 font-semibold text-2xl">11. Confidentiality</h2>
						<p className="mb-4 text-gray-700 dark:text-gray-300">
					...
					<section>
						<h2 className="mb-4 font-semibold text-2xl">12. Force Majeure</h2>
						<p className="mb-4 text-gray-700 dark:text-gray-300">
					...
					<section>
						<h2 className="mb-4 font-semibold text-2xl">13. Insurance</h2>
						<p className="mb-4 text-gray-700 dark:text-gray-300">
			...
			<div className="rounded-lg bg-blue-50 p-8 text-center dark:bg-blue-900">
				<h2 className="mb-4 font-semibold text-2xl">Have questions about our terms?</h2>
