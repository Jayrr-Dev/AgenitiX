    ...
    <div className="px-4 py-2 shadow-lg rounded-lg bg-white border-2 border-green-500">
      ...
      <div className="text-center p-2 rounded border">
        ...
        <div className={`text-sm ${
          receivedValue === true ? "text-green-600" : 
          receivedValue === false ? "text-red-600" : "text-gray-500"
        }`}>
          {receivedValue !== undefined ? 
            `Received: ${typeof receivedValue}` : "Waiting for input..."}
        </div>
      </div>
...
function SimpleFlowExample() {
  ...
  const handleDataChange = useCallback((sourceNodeId: string, newData: any) => {
