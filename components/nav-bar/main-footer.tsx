        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <p className="font-serif text-mutedFg text-sm">
              Agenitix builds agentic-AI tooling for developers who need
              production-grade autonomy out of the box.
            </p>
          </div>

          {/* Quick links */}
          <div className="space-y-4">
            <h3 className="font-semibold font-ui text-foreground text-lg">
              Quick Links
            </h3>
